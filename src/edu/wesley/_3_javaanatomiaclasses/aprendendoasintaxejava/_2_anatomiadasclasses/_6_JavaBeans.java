package edu.wesley._3_javaanatomiaclasses.aprendendoasintaxejava._2_anatomiadasclasses;
...
public class _6_JavaBeans {
    public static void main(String[] args) {
         ...
         * Java Beans
          ...
          a níveis que sejam compreendidos por todo seu time ou por você mesmo no
          futuro. Para isso, a linguagem Java sugere através de convenções, uma escrita
         ...
         * Métodos
          ...
          minúsculas e maiúsculas. Em princípio todas as letras que compõem o nome
          devem ser mantidas em minúsculo, com exceção da primeira letra de cada
          palavra composta, a partir da segunda palavra.
