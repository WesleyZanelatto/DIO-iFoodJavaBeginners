...
public class _1_Escopo {
         ...
         * variável não pode ser lida ou manipulada por rotinas e códigos que estão fora
         * do seu bloco de declaração, ou seja, fora do escopo da variável.
         * Em uma Classe, podemos visualizar a diferença de escopos. Os atributos
         * (variáveis) são declarados no corpo principal da Classe, sendo portanto,
         ...
         * determinar a localização do código em questão. Sem um domínio sobre escopo de
         * códigos, seu projeto tende a conter falhas estruturais e comprometer a
